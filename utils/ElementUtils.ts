    ...
    export class ElementUtil{
        ...
        async doubleClick(locator: flexibleLocator): Promise<void>{
                await this.getLocator(locator).dblclick({timeout
                    :this.defaulttimeout
                });
    ...
    /**
        ...
        */
        ...
        async clear(locator: flexibleLocator): Promise<void>{
                await this.getLocator(locator).clear({timeout
                    :this.defaulttimeout
                });
         ...
         */   
        async isEleVisible(locator: flexibleLocator, index?:number): Promise<boolean> {
         ...
         */
        async attributeValue(locator: flexibleLocator, attributeVal: string): Promise<string |null>{
     ...
     */
    async isAttached(locator: flexibleLocator, timeout: number= 5000): Promise<boolean>{
            try{
    ...
    async selectByIndex(locator: flexibleLocator,indexVal: number ){
        await this.getLocator(locator).selectOption({index: indexVal},{timeout: this.defaulttimeout});
